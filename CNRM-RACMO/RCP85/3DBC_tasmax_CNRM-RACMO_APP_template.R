...
for (p in 1:length(idy))
{
  ...
  if (RefYear > 2014)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmax/Fut/cnrm-r1i1p1-racmo_rcp85_eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmax/Fut/cnrm-r1i1p1-racmo_rcp85_eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",YEAR,".nc4",sep=""))
  FutA <- ncvar_get(nc,"tasmax",start = c(1,idy[p],1), count=c(-1,szy[p],-1))
  nc_close(nc)
  
  # Mean temperature (as lower limit)
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tas/FutC/cnrm-r1i1p1-racmo_rcp85_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tas_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmax/FutC/cnrm-r1i1p1-racmo_rcp85_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",YEAR,".nc4",sep=""),write=TRUE)
