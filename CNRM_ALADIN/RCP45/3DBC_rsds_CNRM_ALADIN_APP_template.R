...
for (p in 1:length(idy))
{
  ...
  refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/Cur/cnrm-r1i1p1-aladin_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2014)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/Fut/cnrm-r1i1p1-aladin_rcp45_eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/Fut/cnrm-r1i1p1-aladin_rcp45_eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/FutC/cnrm-r1i1p1-aladin_rcp45_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",YEAR,".nc4",sep=""),write=TRUE)
