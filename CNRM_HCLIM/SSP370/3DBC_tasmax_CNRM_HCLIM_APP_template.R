...
for (p in 1:length(idy))
{
  ...
  refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmax/Cur/cnrm-r1i1p1f2-hclim_hist_eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmax/Fut/cnrm-r1i1p1f2-hclim_ssp370_eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmax/Fut/cnrm-r1i1p1f2-hclim_ssp370_eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",YEAR,".nc4",sep=""))
  FutA <- ncvar_get(nc,"tasmax",start = c(1,idy[p],1), count=c(-1,szy[p],-1))
  nc_close(nc)
  
  # Mean temperature (as lower limit)
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tas/FutC/cnrm-r1i1p1f2-hclim_ssp370_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tas_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmax/FutC/cnrm-r1i1p1f2-hclim_ssp370_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",YEAR,".nc4",sep=""),write=TRUE)
...
print("==========================================")
print("Recompression")
ifile <- paste0("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmax/FutC/cnrm-r1i1p1f2-hclim_ssp370_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmax_daily_",YEAR,".nc4")
