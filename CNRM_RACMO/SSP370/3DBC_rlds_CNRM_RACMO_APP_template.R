...
for (p in 1:length(idy))
{
  ...
  refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/rlds/Cur/cnrm-r1i1p1f2-racmo_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/rlds/Fut/cnrm-r1i1p1f2-racmo_ssp370_eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/rlds/Fut/cnrm-r1i1p1f2-racmo_ssp370_eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/rlds/FutC/cnrm-r1i1p1f2-racmo_ssp370_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4",sep=""),write=TRUE)
...
print("==========================================")
print("Recompression")
ifile <- paste0("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/rlds/FutC/cnrm-r1i1p1f2-racmo_ssp370_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4")
