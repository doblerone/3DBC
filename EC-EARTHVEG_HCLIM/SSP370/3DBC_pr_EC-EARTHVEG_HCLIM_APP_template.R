...
for (p in 1:length(idy))
{
  ...
  #read data
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/Obs/seNorge2018_RR_",RefYear,".nc",sep=""))
  ObsA <- ncvar_get(nc,"rr",start = c(1,idy[p],1), count=c(-1,szy[p],-1))/24/3600 #convert to mm/seconds
  nc_close(nc)
  
  refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/Cur/ecearthveg-r1i1p1f1-hclim_hist_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/Fut/ecearthveg-r1i1p1f1-hclim_ssp370_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/Fut/ecearthveg-r1i1p1f1-hclim_ssp370_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/FutC/ecearthveg-r1i1p1f1-hclim_ssp370_3dbc-eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",YEAR,".nc4",sep=""),write=TRUE)
...
print("==========================================")
print("Recompression")
ifile <- paste0("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/pr/FutC/ecearthveg-r1i1p1f1-hclim_ssp370_3dbc-eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",YEAR,".nc4")
