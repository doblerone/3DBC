...
ObsA <- ncvar_get(nc,"ps")
nc_close(nc)

nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/Cur/ecearth-r12i1p1-cclm_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",RefYear,".nc4",sep=""))
CurA <- ncvar_get(nc,"ps")
nc_close(nc)
...
nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/Cur/ecearth-r12i1p1-cclm_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",YEAR,".nc4",sep=""))
FutA <- ncvar_get(nc,"ps")
nc_close(nc)
...
nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/CurC/app/ecearth-r12i1p1-cclm_hist_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",YEAR,".nc4",sep=""),write=TRUE)
ncvar_put(nc,"ps",FutCA)
nc_close(nc)
