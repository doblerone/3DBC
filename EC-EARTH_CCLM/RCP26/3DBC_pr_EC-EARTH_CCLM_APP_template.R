...
for (p in 1:length(idy))
{
  ...
  refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/pr/Cur/ecearth-r12i1p1-cclm_hist_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2014)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/pr/Fut/ecearth-r12i1p1-cclm_rcp26_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/pr/Fut/ecearth-r12i1p1-cclm_rcp26_eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/pr/FutC/ecearth-r12i1p1-cclm_rcp26_3dbc-eqm-sn2018v2005_rawbc_norway_1km_pr_daily_",YEAR,".nc4",sep=""),write=TRUE)
