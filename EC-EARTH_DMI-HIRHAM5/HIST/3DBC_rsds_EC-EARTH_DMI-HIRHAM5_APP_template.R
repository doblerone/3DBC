...
for (p in 1:length(idy))
{
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/Cur/ecearth-r3i1p1-hirham_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",RefYear,".nc4",sep=""))
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/Cur/ecearth-r3i1p1-hirham_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rsds/CurC/app/ecearth-r3i1p1-hirham_hist_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rsds_daily_",YEAR,".nc4",sep=""),write=TRUE)
