...
for (p in 1:length(idy))
{
  ...
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/hurs/Fut/ecearth-r3i1p1-hirham_rcp85_eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/hurs/Fut/ecearth-r3i1p1-hirham_rcp85_eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/hurs/FutC/ecearth-r3i1p1-hirham_rcp85_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",YEAR,".nc4",sep=""),write=TRUE)
