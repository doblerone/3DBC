...
for (p in 1:length(idy))
{
  ...
  if (RefYear > 2014)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/Fut/ecearth-r12i1p1-rca_rcp85_eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/Fut/ecearth-r12i1p1-rca_rcp85_eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/ps/FutC/ecearth-r12i1p1-rca_rcp85_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_ps_daily_",YEAR,".nc4",sep=""),write=TRUE)
