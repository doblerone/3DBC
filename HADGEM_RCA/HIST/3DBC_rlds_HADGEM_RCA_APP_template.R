...
for (p in 1:length(idy))
{
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rlds/Cur/hadgem-r1i1p1-rca_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",RefYear,".nc4",sep=""))
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rlds/Cur/hadgem-r1i1p1-rca_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rlds/CurC/app/hadgem-r1i1p1-rca_hist_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4",sep=""),write=TRUE)
