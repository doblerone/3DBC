...
for (p in 1:length(idy))
{
  ...
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmin/Fut/hadgem-r1i1p1-remo_rcp85_eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmin/Fut/hadgem-r1i1p1-remo_rcp85_eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmin/FutC/hadgem-r1i1p1-remo_rcp85_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4",sep=""),write=TRUE)
