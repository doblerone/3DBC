...
for (p in 1:length(idy))
{
  ...
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/sfcWind/Fut/mpi-r1i1p1-cclm_rcp85_eqm-klinogrid1612_rawbc_norway_1km_sfcWind_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/sfcWind/Fut/mpi-r1i1p1-cclm_rcp85_eqm-klinogrid1612_rawbc_norway_1km_sfcWind_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/sfcWind/FutC/mpi-r1i1p1-cclm_rcp85_3dbc-eqm-klinogrid1612_rawbc_norway_1km_sfcWind_daily_",YEAR,".nc4",sep=""),write=TRUE)
