...
for (p in 1:length(idy))
{
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmin/Cur/noresm-r1i1p1f1-hclim_hist_eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",RefYear,".nc4",sep=""))
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmin/Cur/noresm-r1i1p1f1-hclim_hist_eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmin/CurC/app/noresm-r1i1p1f1-hclim_hist_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4",sep=""),write=TRUE)
...
print("==========================================")
print("Recompression")
ifile <- paste0("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/work/tasmin/CurC/app/noresm-r1i1p1f1-hclim_hist_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4")
