...
for (p in 1:length(idy))
{
  ...
  #read data
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/Obs/HySN5_historical_hurs_daily_",RefYear,".nc4",sep=""))
  ObsA <- ncvar_get(nc,"hurs",start = c(1,idy[p],1), count=c(-1,szy[p],-1))
  nc_close(nc)
  
  refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/Cur/noresm-r1i1p1f1-hclim_hist_eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",RefYear,".nc4",sep="")
  if (RefYear > 2020)
    refsimfile <- paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/Fut/noresm-r1i1p1f1-hclim_ssp370_eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",RefYear,".nc4",sep="")
  ...
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/Fut/noresm-r1i1p1f1-hclim_ssp370_eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",YEAR,".nc4",sep=""))
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/FutC/noresm-r1i1p1f1-hclim_ssp370_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",YEAR,".nc4",sep=""),write=TRUE)
...
print("==========================================")
print("Recompression")
ifile <- paste0("/lustre/storeC-ext/users/kin2100/MET/3DBC/application/CMIP6/hurs/FutC/noresm-r1i1p1f1-hclim_ssp370_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_hurs_daily_",YEAR,".nc4")
