...
for var in pr tas tasmin tasmax sfcWind hurs ps rlds rsds
 ...
 cd ${BASEDIR}/${var}/Cur
 for model in miroc-r1i1p1f1-icon mpi-r1i1p1f1-icon mpi-r1i1p1f1-racmo #ecearth-r1i1p1f1-racmo ecearthveg-r1i1p1f1-cclm mpi-r1i1p1f1-hclim cnrm-r1i1p1f2-hclim ecearthveg-r1i1p1f1-hclim noresm-r1i1p1f1-hclim
